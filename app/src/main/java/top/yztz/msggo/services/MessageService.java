...
public class MessageService extends Service {
    ...
    public interface Callback {
        ...
        void onMessageFailed(int index, String reason);
    }
    ...
    public void initSession(int total) {
        ...
        // تنظيف بيانات الجلسة السابقة لمنع تداخل البيانات
        if (smsStatusReceiver instanceof SMSBroadcastReceiver) {
            ((SMSBroadcastReceiver) smsStatusReceiver).clear();
        }
